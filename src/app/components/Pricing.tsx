    ...
    <section id="pricing" className="py-28 bg-[#E8E6E1]">
      <div className="max-w-7xl mx-auto px-6 md:px-10" ref={ref}>
        ...
        <motion.div
          ...
          className="mt-14 bg-[#1F1426] px-8 py-16"
        ...
        {/* ── 2. Creative Services (Brand Identity + Logo Design) ── */}
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        {/* ── 4. Content Day (On-Location Production) ── */}
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        {/* ── 5. Social Media Packages (Essential / Growth / Scale) ── */}
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="text-center mb-14">
            <div className="flex items-center justify-center gap-3 mb-5">
              ...
              <span
                ...
                style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "11px", fontWeight: 500 }}
              >
                {lang === "es" ? "Gestión de Redes Sociales" : "Social Media Management"}
              </span>
              <div className="w-8 h-px bg-[#D4AF37]" />
            </div>
            <h3
            ...
            >
              {lang === "es" ? "Elige Tu Plan de Crecimiento" : "Choose Your Growth Plan"}
            </h3>
          </div>
